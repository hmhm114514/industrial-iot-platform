  ...
  <div class="page-stack">
    ...
    <el-card class="table-card" shadow="never">
      <el-table :data="rows" stripe @sort-change="handleSortChange">
        ...
        <el-table-column prop="status" label="状态" width="110" sortable="custom"><template #default="{ row }"><el-tag :type="statusTag(row.status)" round>{{ row.status }}</el-tag></template></el-table-column>
