...
项目采用前端单页应用 + 后端微服务结构，实现“设备接入—数据上报—规则告警—统计展示—告警处置—日志审计”的核心业务闭环，并提供 PandaX 参考功能中的设备管理、服务管理、规则引擎、组态大屏、视频中心、数据中心和系统设置等模块。
...
11. 进入“系统设置 / 操作日志”，查看登录、设备、规则、视频和智能体等审计记录。
